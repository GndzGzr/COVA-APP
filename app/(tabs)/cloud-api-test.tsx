...
import { getATMPrediction, getVLMPrediction, getObstacleDetection } from '../../scripts/googleCloudApi';
import { ThemedText } from '@/components/ThemedText';
import { ThemedView } from '@/components/ThemedView';

type Mode = 'atm' | 'vlm' | 'obstacle';

export default function CloudApiTestScreen() {
  ...
  return (
    ...
    >
      <ScrollView style={styles.container}>
        <Stack.Screen options={{ title: 'Cloud API Test', headerShown: true }} />

        <ThemedView style={styles.content}>
          <ThemedText type="title" style={styles.title}>Cloud Vision AI Test</ThemedText>
          ...
          >
            {loading ? (
              ...
              <ThemedText style={styles.processButtonText}>
                {mode === 'vlm' ? 'Ask AI' : 
                 mode === 'obstacle' ? 'Get Walking Assistance' : 
                 'Process ATM Scene'}
              </ThemedText>
            )}
          </TouchableOpacity>
